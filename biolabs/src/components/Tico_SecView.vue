        ...
        <div class="modal-content">
          ...
          <div class="modal-body" v-for="detail in details" :key="detail.id">
            <div class="row pl-4">
              ...
              <div class="col-6">
                <label class="text-primary">RECEIVED BY BD</label>
                <p>Benith</p>
              </div>
              <div class="col-6">
          ...
          <center>
            <router-link to="/ticosecdash" type="button" class="btn bg-primary mb-3 mt-1" data-dismiss="modal">CLOSE</router-link>
            <router-link to="/ticoadd"><button type="button" class="btn bg-success text-white mb-3 mt-1 ml-1" data-dismiss="modal">IMPORT DATA</button></router-link>
          </center>
        </div>
      </div>
    </div>
