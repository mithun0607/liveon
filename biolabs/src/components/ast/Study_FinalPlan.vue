                ...
                <div id="collapseOne" class="collapse" data-parent="#accordionExample">
                  <div class="row ml-2 mr-2 mt-3">
                    <div class="col-12 mt-2 mb-3">
                      The objective of this toxicity study is to assess the potential <u>{{detail.obj}}</u> by injecting both polar extract (i.e., by slow bolus intravenous injection) for single administration and non-polar extract (i.e., by slow bolus intraperitoneal injection) for single administration. Also, this test provides information on health hazards likely to be arise from acute exposure by the intended clinical route in humans.
                    </div>
                  </div>
                </div>
              </div>
                    ...
                    <div class="col-12 mt-2 mb-3">
                      <table class="table table-bordered">
                        <tbody>
                          ...
                          <tr>
                            <td>Study Personnel I</td>
                            <td><u>Mr. Balaji S.</u></td>
                          </tr>
                          <tr>
                            <td>Study Personnel II</td>
                            <td><u>Mr. Kumaraswamy S.B.</u></td>
                          </tr>
                          <tr>
                            <td>Study Personnel III</td>
                            <td><u>Ms. Roja M.Y.</u></td>
                          </tr>
                          <tr>
                            <td>Study Personnel IV</td>
                            <td><u>Ms. Divyashree K.</u></td>
                          </tr>
                          <tr>
                            <td>Study Personnel V</td>
                            <td><u>Mr. Girish A.</u></td>
                          </tr>
                          <tr>
                            <td>Study Personnel VI</td>
                            <td><u>Mr. Udayakumar V.G.</u></td>
                          </tr>
                          <tr>
                            <td>Study Personnel VII</td>
                            <td><u>Dr. Sunkad Meghana</u></td>
                          </tr>
                          <tr>
            ...
            <div class="accordion mt-4" id="accordionExample">
              <div class="card rounded">
                <div class="card-header" data-toggle="collapse" data-target="#collapseSeven" aria-expanded="true">     
                  <span class="title">6. STATEMENT OF STUDY COMPLIANCE&nbsp;&nbsp;</span>
                  <span class="accicon"><font-awesome-icon icon="fa-solid fa-angle-down" type="button" /></span>
                </div>
                <div id="collapseSeven" class="collapse" data-parent="#accordionExample">
                  <div class="row ml-2 mr-2 mt-3">  
                    <div class="col-12 mt-2 mb-3">
                      <p>Study Number : {{ detail.study_no }} </p>
                      <p>Study Title : {{ detail.study_title1 }} </p>
                      <p>This Study was performed in compliance with OECD Principles of GLP for
                         testing of chemicals as specified by international [(C (97)186/Final] legislation
                         and in compliance with ISO/IEC 17025:2017. This study was conducted in
                         accordance with the standard operating procedures and the mutually agreed
                         study plan signed by Study Director on 21/12/2022, Sponsor representative
                         and monitoring scientist on XX/XX/XXXX.</p>
                      <p class="font-weight-bold text-center">DECLARATION</p>
                      <p>The Study Director hereby declares that the work was performed under her
                         supervision and in accordance with the described procedures. It is assured
                         that the reported results faithfully represent the raw data obtained during the
                         experimental work. No circumstances have been left unreported which may
                         have affected the quality or integrity of the data or which might have a
                         potential bearing on the validity and reproducibility of this study.</p><br>
                        <p>The Study Director accepts overall responsibility for the technical conduct of
                           the study as well as the interpretation, analysis, documentation and reporting
                           of the results.</p>
                    </div>
                  </div>
                </div>
            ...
            <div class="accordion mt-4" id="accordionExample">
              <div class="card rounded">
                ...
                <div id="collapseNine" class="collapse" data-parent="#accordionExample">
                  <div class="row ml-2 mr-2 mt-3">
                    <div class="col-12 mt-2 mb-3">
                      <p>The use of animals for this study has been approved by Liveon Biolabs Private Limited IAEC.IAEC approved Protocol No.: LBPL-IAEC-035-06/2022.</p>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div class="accordion mt-4" id="accordionExample">
              <div class="card rounded">
                <div class="card-header" data-toggle="collapse" data-target="#collapseThirteen" aria-expanded="true">     
                  <span class="title">17. MATERIALS AND METHODS&nbsp;&nbsp; | 17.1 Materials&nbsp;&nbsp; | 13.1.1 Test Item Information&nbsp;&nbsp;</span>
                  <span class="accicon"><font-awesome-icon icon="fa-solid fa-angle-down" type="button" /></span>
                </div>
            ...
            <div class="accordion mt-4" id="accordionExample">
              <div class="card rounded">
                ...
                <div id="collapseSixteen" class="collapse" data-parent="#accordionExample">
                  <div class="row ml-2 mr-2 mt-3">
                    <p>Animals will be housed in an environment-controlled room temperature of <u>{{detail.temp}}</u> and relative humidity of 30-70%. The photoperiod will be 12 hrs fluorescent light and 12hrs darkness. Adequate fresh air supply of 12 - 15 air cycles/hr and sound level of less than 80dB will be maintained in the experimental room.</p>
            ...
            <div class="accordion mt-4" id="accordionExample">
              <div class="card rounded">
                ...
                <div id="collapseSeventeen" class="collapse" data-parent="#accordionExample">
                  <div class="row ml-2 mr-2 mt-3">
                    <p>A group of five animals will be housed in standard polycarbonate cages (<u>{{detail.cage_size}}</u>) with stainless steel mesh top having facilities for holding pelleted food and drinking water with stainless sipper tube. Additionally, tunnels will be provided as an enrichment device to minimizing the animal stress and promote the overall wellbeing of animals.</p>
                    <p>There were no known contaminants in the bedding provided to the animals.
                    Steam sterilized corn cob was provided as bedding material. The latest
                    analysis and contaminants report of bedding material was included in the
                    Annexure 2 & 3.</p>
                  </div>
                </div>
              </div>
            ...
            <div class="accordion mt-4" id="accordionExample">
              <div class="card rounded">
                ...
                <div id="collapseEighteen" class="collapse" data-parent="#accordionExample">
                  <div class="row ml-2 mr-2 mt-3">
                    <p>AF- 1000M R&M Diet’s mice manufactured by <u>{{detail.mfg_by_name}}</u> will be provided ad <i>libitum</i> to mice or others to specify in the report.</p>
                    ...
                    <p>There were no known contaminants in the food and water provided to the animals. The analysis report was included in the Annexure 4 to 7</p>
                  </div>
                </div>
              </div>
            </div>
