            ...
            <table id="example2" class="table table-striped table-bordered text-center" cellspacing="0" width="100%">
              <thead>
                <tr>
                  ...
                  <th class="th-sm text-center">BD Personel Name
                  </th>
              ...
              <tbody>
                <tr v-for="detail in details" :key="detail.id">
                  ...
                  <td class="text-primary">{{detail.tfm_status}}</td>
                  <td><font-awesome-icon icon="fa-solid fa-envelope" type="button"/></td>
                  <td><router-link :to="{ name: 'TfmBdViewID', params: { id: detail.id } }" class="text-dark"><font-awesome-icon icon="fa-solid fa-eye" type="button"/></router-link></td>
                </tr>
              </tbody>
            </table>
          </div>
